...
public interface VeiculoWeb {
    ...
    @RequestWrapper(localName = "getVeiculo", targetNamespace = "http://webService/", className = "webService.client.GetVeiculo")
    @ResponseWrapper(localName = "getVeiculoResponse", targetNamespace = "http://webService/", className = "webService.client.GetVeiculoResponse")
