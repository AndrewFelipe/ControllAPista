...
public interface TransitoWeb {
     ...
     * @param arg0
     * @return
     *     returns java.util.List<webService.cliente.Semaforo>
     */
    @WebMethod
    @WebResult(targetNamespace = "")
    @RequestWrapper(localName = "getSemaforosFromRua", targetNamespace = "http://webService/", className = "webService.cliente.GetSemaforosFromRua")
    @ResponseWrapper(localName = "getSemaforosFromRuaResponse", targetNamespace = "http://webService/", className = "webService.cliente.GetSemaforosFromRuaResponse")
    @Action(input = "http://webService/TransitoWeb/getSemaforosFromRuaRequest", output = "http://webService/TransitoWeb/getSemaforosFromRuaResponse")
    public List<Semaforo> getSemaforosFromRua(
        @WebParam(name = "arg0", targetNamespace = "")
        String arg0);
