...
import generatedCorba.EstacionamentoControllerImpl;
...
public class servidor
{
  public static void main(String args[]) {
	  try{
	      ...
	      EstacionamentoControllerImpl impl = new EstacionamentoControllerImpl();
	      ...
	      EstacionamentoController href = EstacionamentoControllerHelper.narrow(ref);
